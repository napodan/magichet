...
gs_tools.workbench_formspec = function(pos, params)
                ...
                if ri then
                        ...
                        if gs_tools.crafts[item][recipe].type == "unknown" then
                                rec = rec .. "label[4.5,1;No known recipe for]" ..
                                        "label[4.5,1.25;" .. item .. "]" ..
                                        "label[4.5,1.75;You probably need to gather it.]"
                        end
                end
        ...
        -- player inventory
        local pinv = "list[current_player;main;4.5,4.75;8,4;]"
        ...
        local fs = "size[12.5,8.75]" .. mods .. listhead .. ilv .. stxt .. rec ..
                cbut .. craft .. pinv..
