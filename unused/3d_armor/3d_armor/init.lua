...
minetest.register_tool("3d_armor:chestplate_wood", {
    ...
    groups = {armor_torso=15, armor_heal=0, armor_use=2000},
    enchantability = 15,
    wear = 0,
})
...
minetest.register_tool("3d_armor:chestplate_steel", {
    ...
    groups = {armor_torso=25, armor_heal=0, armor_use=500},
    enchantability = 14,
    wear = 0,
})
...
minetest.register_tool("3d_armor:chestplate_bronze", {
    ...
    groups = {armor_torso=30, armor_heal=6, armor_use=250},
    enchantability = 10,
    wear = 0,
})
...
minetest.register_tool("3d_armor:chestplate_diamond", {
    ...
    groups = {armor_torso=40, armor_heal=12, armor_use=100},
    enchantability = 10,
    wear = 0,
})
...
if use_moreores then
    minetest.register_tool("3d_armor:chestplate_mithril", {
        ...
        groups = {armor_torso=40, armor_heal=12, armor_use=50},
        enchantability = 24,
        wear = 0,
    })
end
...
minetest.register_tool("3d_armor:leggings_wood", {
    ...
    groups = {armor_legs=10, armor_heal=0, armor_use=2000},
    enchantability = 15,
    wear = 0,
})
...
minetest.register_tool("3d_armor:leggings_bronze", {
    ...
    groups = {armor_legs=20, armor_heal=6, armor_use=250},
    enchantability = 10,
    wear = 0,
})
...
minetest.register_tool("3d_armor:leggings_diamond", {
    ...
    groups = {armor_legs=30, armor_heal=12, armor_use=100},
    enchantability = 10,
    wear = 0,
})
...
if use_moreores then
    minetest.register_tool("3d_armor:leggings_mithril", {
        ...
        groups = {armor_legs=30, armor_heal=12, armor_use=50},
        enchantability = 14,
        wear = 0,
    })
end
