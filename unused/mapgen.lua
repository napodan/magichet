...
minetest.register_on_generated(function(minp, maxp, seed)
    if maxp.y >= 2 and minp.y <= 0 then
        ...
        for divz=0+1,divs-1-1 do
            ...
            if minetest.env:get_node({x=cx,y=1,z=cz}).name:find("water_source") and
                    minetest.env:get_node({x=cx,y=0,z=cz}).name:find("sand") then
                local is_shallow = true
                local num_water_around = 0
                if minetest.env:get_node({x=cx-divlen*2,y=1,z=cz+0}).name:find("water_source") then
                    num_water_around = num_water_around + 1 end
                if minetest.env:get_node({x=cx+divlen*2,y=1,z=cz+0}).name:find("water_source") then
                    num_water_around = num_water_around + 1 end
                if minetest.env:get_node({x=cx+0,y=1,z=cz-divlen*2}).name:find("water_source") then
                    num_water_around = num_water_around + 1 end
                if minetest.env:get_node({x=cx+0,y=1,z=cz+divlen*2}).name:find("water_source") then
                    num_water_around = num_water_around + 1 end
                ...
                if is_shallow then
                    ...
                    for z1=-divlen,divlen do
                        if minetest.env:get_node({x=cx+x1,y=0,z=cz+z1}).name:find("sand") then
        ...
        for divz=0,divs-1 do
            ...
            for i=0,sugar_cane_amount do
                local x = pr:next(math.min(x0, x1),math.max(x0, x1))
                local z = pr:next(math.min(z0, z1),math.max(z0, z1))
...
replace("air", "default:bedrock", -4999, -4995)
replace("air", "default:lava_source", -4999, -4995)
replace("default:stone", "default:bedrock", -4999, -4995)
replace("default:gravel", "default:bedrock", -4999, -4995)
replace("default:dirt", "default:bedrock", -4999, -4995)
replace("default:sand", "default:bedrock", -4999, -4995)
replace("default:cobble", "default:bedrock", -4999, -4995)
replace("default:mossycobble", "default:bedrock", -4999, -4995)
replace("stairs:stair_cobble", "default:bedrock", -4999, -4995)
replace("default:lava_source", "default:bedrock", -4999, -4995)
replace("default:lava_flowing", "default:bedrock", -4999, -4995)
replace("default:water_source", "default:bedrock", -4999, -4995)
replace("default:water_flowing", "default:bedrock", -4999, -4995)
