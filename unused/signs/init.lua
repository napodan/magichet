-- Font: 04.jp.org + 4aiman's RU (crapy) additions
local locale = os.setlocale('Russian_Russia.65001', 'collate')
if not locale then os.setlocale('ru_RU.UTF-8','collate') end
...
local update_sign = function(pos, fields)
    ...
    if fields then
        ...
        minetest.chat_send_all(fields.text .. "  - org!")
...
generate_line = function(s, ypos)
    ...
    while chars < max_chars and i <= #s do
        ...
        elseif i < #s and charmap[s:sub(i, i + 1)] ~= nil then
            ...
            print("[signs] W: непонятный символ в строке '"..s.."' в позиции "..i.." (наверно, это '"..s:sub(i, i).."'?)")
            i = i + 1
        end
        if file ~= nil then
