...
voltbuild.production_spec = "list[current_name;src;2,1;1,1;]list[current_name;dst;5,1.5;2,2;]"
voltbuild.components_spec = "list[current_name;components;5,0;4,1;]"
