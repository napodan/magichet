...
specialties.skills = {}
specialties.skills["miner"] = {menu="button[4.5,1;3,0.5;healpick;(100)Починка]"..
            "button[4.5,1.65;3,0.5;upgradepick;(200)Апгрейд]"..
            "button[4.5,2.3;3,0.5;superheatpick;(500)Плавка]"..
            "list[current_player;pick;5.5,0;1,1;]",
                    specials={{name="superheat", description="Плавка"}},
                    tool="pick"}
specialties.skills["lumberjack"] = {menu="button[4.5,1;3,0.5;healaxe;(100)Починка]"..
            "button[4.5,1.65;3,0.5;upgradeaxe;(200)Апгрейд]"..
            "button[4.5,2.3;3,0.5;superheataxe;(500)Плавка]"..
            "button[4.5,2.95;3,0.5;felleraxe;(750)Автосрубание]"..
            "list[current_player;axe;5.5,0;1,1;]",
                    specials={{name="superheat", description="Плавка"},
                              {name="feller",    description="Автосрубание"}},
                    tool="axe"}
specialties.skills["digger"] = {menu="button[4.5,1;3,0.5;healshovel;(100)Починка]"..
            "button[4.5,1.65;3,0.5;upgradeshovel;(200)Апгрейд]"..
            "button[4.5,2.3;3,0.5;superheatshovel;(500)Плавка]"..
            "list[current_player;shovel;5.5,0;1,1;]",
                    specials={{name="superheat", description="Плавка"}},
                    tool="shovel"}
specialties.skills["builder"] = {menu="button[4.5,1;3,0.5;grantfast;(600)Ускорение]"..
            "button[4.5,1.65;3,0.5;grantfly;(800)Полёт(80сек)]",
                    specials={}, tool=""}
if(minetest.get_modpath("farming") ~= nil or minetest.get_modpath("farming") ~= "") then
specialties.skills["farmer"] = {menu="button[4.5,1;3,0.5;healhoe;(100)Починка]"..
            "button[4.5,1.65;3,0.5;upgradehoe;(200)Апгрейд]"..
            "button[4.5,2.3;3,0.5;greenthumb;(500)Садовник]"..
            "list[current_player;hoe;5.5,0;1,1;]",
                    specials={{name="greenthumb", description="Садовник"}},
                    tool="hoe"}
end
