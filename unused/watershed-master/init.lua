...
local YMIN = 160 -- Approximate base of realm stone
local YMAX = 250 -- Approximate top of atmosphere / mountains / floatlands
local TERCEN = 200 -- Terrain 'centre', average seabed level
local YWAT = 140 -- Sea level
local YCLOUD = 240 -- Cloud level
...
minetest.register_on_generated(function(minp, maxp, seed)
    ...
    local c_drydirt = minetest.get_content_id("ethereal:dry_dirt")
    local c_jundirt = minetest.get_content_id("ethereal:jungle_dirt")
    local c_firdirt = minetest.get_content_id("ethereal:fiery_dirt_top")
