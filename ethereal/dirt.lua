...
minetest.register_node("ethereal:cold_dirt", {
    ...
    is_ground_content = true,
    groups = {crumbly=default.dig.wood, soil=1,ethereal_grass=1},
    drop = 'default:dirt',
    sounds = default.node_sound_dirt_defaults()
})
...
minetest.register_node("ethereal:crystal_topped_dirt", {
    ...
    is_ground_content = true,
    groups = {crumbly=default.dig.ice, soil=1,ethereal_grass=1},
    drop = 'default:dirt',
    sounds = default.node_sound_dirt_defaults()
})
...
minetest.register_node("ethereal:mushroom_dirt", {
    ...
    is_ground_content = true,
    groups = {crumbly=default.dig.snow, soil=1,ethereal_grass=1},
    drop = 'default:dirt',
    sounds = default.node_sound_dirt_defaults()
})
