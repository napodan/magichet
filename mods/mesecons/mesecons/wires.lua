...
box_center = {-2/16, -.5, -2/16, 2/16, -.5+1/16, 2/16}--
box_bump1 =  { -2/16, -8/16,  -2/16, 2/16, -13/32, 2/16 }--

box_xp = {1/16, -.5, -2/16, 8/16, -.5+1/16, 2/16}--
box_zp = {-2/16, -.5, 1/16, 2/16, -.5+1/16, 8/16}--
box_xm = {-8/16, -.5, -2/16, -1/16, -.5+1/16, 2/16}--
box_zm = {-2/16, -.5, -8/16, 2/16, -.5+1/16, -1/16}--

box_xpy = {.5-1/16, -.5+1/16, -2/16, .5, .4999+1/16, 2/16}--
box_zpy = {-2/16, -.5+1/16, .5-1/16, 2/16, .4999+1/16, .5}--
box_xmy = {-.5, -.5+1/16, -2/16, -.5+1/16, .4999+1/16, 2/16}--
box_zmy = {-2/16, -.5+1/16, -.5, 2/16, .4999+1/16, -.5+1/16}--
...
if not minetest.registered_nodes["default:stone_with_mese"] then --before MESE update, use old recipes
        ...
        minetest.register_craft({
                type = "cooking",
                output = "mesecons:wire_00000000_off 1",
        ...
        minetest.register_craft({
                type = "cooking",
                output = "mesecons:wire_00000000_off 81",
                recipe = "default:mese",
                cooktime = 30,
        })
