...
c_junglesapling  = minetest.get_content_id("ethereal:jungle_tree_sapling")
c_jungletree  = minetest.get_content_id("default:jungletree")
c_jungleleaves  = minetest.get_content_id("default:jungleleaves")
c_savannasapling  = minetest.get_content_id("ethereal:jungle_tree_sapling")
c_savannatree = minetest.get_content_id("default:jungletree")
c_savannaleaves  = minetest.get_content_id("ethereal:bananaleaves")
