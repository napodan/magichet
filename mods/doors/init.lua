...
doors:register_door("doors:door_wood", {
    ...
    groups = {choppy=default.dig.wood,oddly_breakable_by_hand=2,flammable=2,door=1},
...
doors:register_door("doors:door_steel", {
    ...
    groups = {crumbly=default.dig.iron_door,bendy=2,cracky=1,melty=2,level=2,door=1},
...
doors:register_door("doors:door_glass", {
    ...
    groups = {snappy=default.dig.glass,cracky=default.dig.glass,oddly_breakable_by_hand=3,door=1},
...
doors:register_door("doors:door_obsidian_glass", {
    ...
    groups = {cracky=default.dig_iron,oddly_breakable_by_hand=3,door=1},
