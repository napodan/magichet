If you have downloaded 1 or more of my mods, you've probably noticed that there are no textures for new items/nodes.
...
So far this texturepack supports to some extent (so don't expect this mod to change all textures from, say, mesecons) following mods:
 ...
 - creatures
 - default (from default of: minetest_game, default, MiniTest)
 - desert_uses
 - diamonds
 - door
 - dye
