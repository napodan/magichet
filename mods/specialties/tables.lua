...
specialties.skills = {}
specialties.skills["miner"] = {menu="button[4.5,1;3,0.5;healpick;(100)Fix]"..
            "button[4.5,1.65;3,0.5;upgradepick;(200Upgrade]"..
            "button[4.5,2.3;3,0.5;superheatpick;(500)Smelting]"..
            "list[current_player;pick;5.5,0;1,1;]",
                    specials={{name="superheat", description="Smelting"}},
                    tool="pick"}
specialties.skills["lumberjack"] = {menu="button[4.5,1;3,0.5;healaxe;(100)Fix]"..
            "button[4.5,1.65;3,0.5;upgradeaxe;(200)Upgrade]"..
            "button[4.5,2.3;3,0.5;superheataxe;(500)Smelting]"..
            "button[4.5,2.95;3,0.5;felleraxe;(750)Autocut]"..
            "list[current_player;axe;5.5,0;1,1;]",
                    specials={{name="superheat", description="Smelting"},
                              {name="feller",    description="Autocut"}},
                    tool="axe"}
specialties.skills["digger"] = {menu="button[4.5,1;3,0.5;healshovel;(100)Fix]"..
            "button[4.5,1.65;3,0.5;upgradeshovel;(200)Upgrade]"..
            "button[4.5,2.3;3,0.5;superheatshovel;(500)Smelting]"..
            "list[current_player;shovel;5.5,0;1,1;]",
                    specials={{name="superheat", description="Smelting"}},
                    tool="shovel"}
specialties.skills["builder"] = {menu="button[4.5,1;3,0.5;grantfast;(600)Speedup!]"..
            "button[4.5,1.65;3,0.5;grantfly;(800)Fly(80s)]",
                    specials={}, tool=""}
if(minetest.get_modpath("farming") ~= nil or minetest.get_modpath("farming") ~= "") then
specialties.skills["farmer"] = {menu="button[4.5,1;3,0.5;healhoe;(100)Fix]"..
            "button[4.5,1.65;3,0.5;upgradehoe;(200)Upgrade]"..
            "button[4.5,2.3;3,0.5;greenthumb;(500)Gardener]"..
            "list[current_player;hoe;5.5,0;1,1;]",
                    specials={{name="greenthumb", description="Gardener"}},
                    tool="hoe"}
end
