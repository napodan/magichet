...
local function dockable(nodename)
    if nodename == "default:wood" or nodename == "default:brick" or nodename == "default:cobble" or nodename == "default:dirt" or nodename == "default:sandstone" or nodename == "default:stone" or string.find(nodename, "fence") then
        return true
    end
end
...
minetest.register_node("fences:fence_wood", {
    ...
    paramtype = "light",
    groups = {choppy=default.dig.wood,oddly_breakable_by_hand=2,flammable=2,fences=1},
...
minetest.register_node("fences:fence_wood_1", {
    tiles = {"default_wood.png"},
    paramtype = "light",
    groups = {choppy=default.dig.wood,oddly_breakable_by_hand=2,flammable=2,fences=1,not_in_inventory=1},
    drop = 'fences:fence_wood',
    sunlight_propagates = true,
